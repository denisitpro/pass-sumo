...
| [`audit-2026-09-13.md`](audit-2026-09-13.md) | Frozen point-in-time code audit of `main` at `563b61e`: dead code, memory/lifetime, unsafe memory, feature correctness, add-new-item validation, dependency currency — findings by severity with file:line evidence and a suggested order of work. |
